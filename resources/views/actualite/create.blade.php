...
<div class="container">
    ...
    <h2>Publier une nouvelle  Actualité</h2>
    ...
    <form action="{{route('actualites.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="prix">Date de publication</label>
            <input type="datetime-local" class="form-control" id="date" name="date_publication" required>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="categorie" name="categorie" required>
                ...
                <option value="Naissance/Décès">Naissance</option>
                <option value="Naissance/Décès">Décès</option>
                <option value="Actualité">Actualité</option>
                <option value="Projets de mairie">Projets de mairie</option>
            </select>
        </div>
