...
<head>
    ...
    <title>Centres commerciaux - Allakro Village</title>
            ...
            <div class="col-12 col-lg-8">
                <div class="archive-catagory-view mb-50 d-flex align-items-center justify-content-between">
                    <div class="archive-catagory">
                        <h4>Centres commerciaux proches d'Allakro</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            <div class="post-thumbnail">
                                <img src="img/bg-img/centrecommerciaux.png" alt="" />
                            ...
                            <div class="post-content">
                                ...
                                <a href="single-post.html" class="post-title">Prosper Alla</a>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            <div class="post-thumbnail">
                                <img src="img/bg-img/supermarche-sococe.png" alt="" />
                            ...
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">Centre commercial</a>
                                <a href="single-post.html" class="post-title">SACR</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            <div class="post-thumbnail">
                                <img src="img/bg-img/abdalah.png" alt="" />
                            ...
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">Centre commercial</a>
                                <a href="single-post.html" class="post-title">Abdalah Fashion</a>
                                <div class="post-meta d-flex">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            ...
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">Centre commercial</a>
                                <a href="single-post.html" class="post-title">Targovi Centre</a>
                                <div class="post-meta d-flex">
                                    <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 22</a>
                                    <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 16</a>
                                    <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 15</a>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            ...
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">Centre commercial</a>
                                <a href="single-post.html" class="post-title">Sococe 2 plateau Agban</a>
                                <div class="post-meta d-flex">
                                    <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 28</a>
                                    <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 17</a>
                                    <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 22</a>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single-post-area mb-50">
                            ...
                            <div class="post-content">
                                <a href="#" class="post-cata cata-sm cata-success">Centre commercial</a>
                                <a href="single-post.html" class="post-title">KYKL</a>
                                <div class="post-meta d-flex">
                                    <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i> 14</a>
                                    <a href="#"><i class="fa fa-eye" aria-hidden="true"></i> 38</a>
                                    <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> 22</a>
